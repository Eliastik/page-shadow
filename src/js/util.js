...
async function customTheme(nb, style, disableCustomCSS, lnkCssElement) {
    ...
    style.sheet.insertRule(".pageShadowContrastBlackCustom a:not(.pageShadowElementDisabled):not(.pageShadowDisableBackgroundStyling):not(.pageShadowDisableLinkStyling):not(.pageShadowHasTransparentBackground) { background-color: transparent !important; }", 0);
