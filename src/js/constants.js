...
const extensionVersion = "2.11.5";
const versionDate = new Date(2025, 8, 15);
...
const customFilterGuideURL = "https://www.eliastiksofts.com/page-shadow/filters/guide/2.11.5.php";
...
const defaultWebsiteSpecialFiltersConfig = {
    ...
    darkThemeDetectionMinimalCoverage: 0,
    ...
    maxReapplyBodyClassesAttempts: 5,
...
const websiteSpecialFiltersProcessingConfig = {
    ...
    darkThemeDetectionMaxLightness: {
        type: "value",
        name: "darkThemeDetectionMaxLightness"
    },
    darkThemeDetectionMaxSaturation: {
        type: "value",
        name: "darkThemeDetectionMaxSaturation"
    },
    darkThemeDetectionMinLightnessLightElements: {
        type: "value",
        name: "darkThemeDetectionMinLightnessLightElements"
    },
    darkThemeDetectionPercentageRatioDarkLightElements: {
        type: "value",
        name: "darkThemeDetectionPercentageRatioDarkLightElements"
    },
    darkThemeDetectionMinimalCoverage: {
        type: "value",
        name: "darkThemeDetectionMinimalCoverage"
    },
    ...
    maxReapplyBodyClassesAttempts: {
        type: "value",
        name: "maxReapplyBodyClassesAttempts"
    }
};
