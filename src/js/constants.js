...
const advancedSettingsRealTimeChangeKeys = ["sitesInterditPageShadow", "whiteList", "defaultLoad", "presets", "customThemes", "filtersSettings", "customFilter", "interfaceDarkTheme", "popupTheme", "advancedOptionsFiltersSettings", "autoBackupCloudInterval", "lastAutoBackupCloud", "lastAutoBackupFailed", "disableRightClickMenu"];
const nbPresets = 10;
