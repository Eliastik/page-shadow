...
const defaultWebsiteSpecialFiltersConfig = {
    ...
    throttleDarkImageDetectionBatchSize: 5,
    throttleDarkImageDetectionMaxExecutionTime: 25,
    ...
    throttledMutationObserverSubchildsTreatedByCall: 15,
    throttledMutationObserverSubchildsMaxExecutionTime: 25,
