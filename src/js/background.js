...
import { getAutoEnableSavedData, checkAutoEnableStartup, isAutoEnable } from "./utils/autoEnableUtils.js";
...
async function updateBadge(storageChanged) {
    if(typeof(browser.tabs) !== "undefined" && typeof(browser.tabs.query) !== "undefined") {
        ...
        for(const tab of tabs) {
            ...
            if(typeof(browser.action) !== "undefined" && typeof(browser.action.setBadgeText) !== "undefined" && !isFirefoxForMobile) {
            ...
            if(typeof(browser.action) !== "undefined" && typeof(browser.action.setBadgeBackgroundColor) !== "undefined" && !isFirefoxForMobile) {
                if(enabled) {
