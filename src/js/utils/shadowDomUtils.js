...
import { sendMessageWithPromise } from "./util.js";
...
function processRulesInvert(parentElement, style, settings, enablePreserveColorsSelectiveInvert) {
    ...
    if(enabled == "true") {
        ...
        if(selectiveInvert == "true") {
            ...
            style.sheet.insertRule(":host *:not(.pageShadowDisableElementInvert) > svg.pageShadowSelectiveInvert:not(.pageShadowHasBrightColorBackground):not(.pageShadowHasBrightColorText):not(a):not(body.pageShadowInvertBrightColors .pageShadowHasBrightColorBackground *):not(.pageShadowDisableBackgroundStyling), :host *:not(.pageShadowDisableElementInvert) > svg.pageShadowSelectiveInvert:not(.pageShadowHasBrightColorBackground):not(.pageShadowHasBrightColorText):not(a):not(body.pageShadowInvertBrightColors .pageShadowHasBrightColorBackground *):not(.pageShadowDisableBackgroundStyling) > * { color: black; }");
        ...
        if(invertBgColors == "true") {
            ...
            if(shouldInvertBrightColors) {
                ...
                style.sheet.insertRule(":host *:not(.pageShadowDisableElementInvert) > .pageShadowHasBackgroundImg:not(.pageShadowDisableElementInvert):not(.pageShadowHasBrightColorBackground) > *:not(picture) { filter: " + invertBgFilter + " !important; -moz-filter: " + invertBgFilter + " !important; -o-filter: " + invertBgFilter + " !important; -webkit-filter: " + invertBgFilter + " !important; }");
